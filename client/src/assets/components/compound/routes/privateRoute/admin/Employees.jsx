...
import EmployeerListAdmin from '../../../../simple/employeerSearch/EmployeerListAdmin'
...
export default function Employees(props) {
    ...
    return (
        <div>
            ...
            <EmployeerListAdmin searchEmployeer={searchEmployeer} employeerList={employeerList}/>  
        </div>
